...
final class Wrong
{
     ...
     * only inside a running analysis.
     */
    public function wrongKindOfMatcherAgainstAnObject(): void
    {
        $gate = Understudy::for(Gate::class);
    ...
    /**
     * The cardinality rule used to read only the first link of the chain, so
